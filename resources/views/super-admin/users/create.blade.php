                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select @error('super_admin_role') is-invalid @enderror" 
                                            ...
                                            <option value="super_admin" {{ old('super_admin_role') === 'super_admin' ? 'selected' : '' }}>Super Admin (Full Access)</option>
                                            <option value="admin" {{ old('super_admin_role') === 'admin' ? 'selected' : '' }}>Admin (Limited Access)</option>
                                        </select>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="manage_users" name="super_admin_permissions[]" value="manage_users" {{ in_array('manage_users', old('super_admin_permissions', [])) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="manage_users">Manage Users</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="manage_businesses" name="super_admin_permissions[]" value="manage_businesses" {{ in_array('manage_businesses', old('super_admin_permissions', [])) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="manage_businesses">Manage Businesses</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="manage_withdrawals" name="super_admin_permissions[]" value="manage_withdrawals" {{ in_array('manage_withdrawals', old('super_admin_permissions', [])) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="manage_withdrawals">Manage Withdrawals</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="manage_tickets" name="super_admin_permissions[]" value="manage_tickets" {{ in_array('manage_tickets', old('super_admin_permissions', [])) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="manage_tickets">Manage Support Tickets</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="manage_balance" name="super_admin_permissions[]" value="manage_balance" {{ in_array('manage_balance', old('super_admin_permissions', [])) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="manage_balance">Manage Business Balances</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="view_reports" name="super_admin_permissions[]" value="view_reports" {{ in_array('view_reports', old('super_admin_permissions', [])) ? 'checked' : '' }}>
